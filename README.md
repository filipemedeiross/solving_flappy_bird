...
> **Note 1**: The image above illustrates the data captured to train the models, namely, the horizontal and vertical distances of the bean in relation to the pipes.

> **Note 2**: The latest models mentioned in item 4 were more robust because they were trained on data that did not contain the noise of the initial data, which reflected the erratic human playing behavior.
